                    ...
                    <form id='Form1' method="post" name="extra_fee_collection_form">
                      <div class="form-row">
                        <div class="form-group">
                          ...
                          <select id="className" onchange='OnSelectionChangeClass (this)' class="form-control" name="class_id">
                         ...
                         <div class="form-group">
                          ...
                          <select onchange='OnSelectionChange (this)' id="feeCategory" class="form-control" name="feetype_id">
                              <option value="" selected >Choose...</option>
                                <?php
                        ...
                        <div class="form-group">
                          <label for="nepaliDateDayBook">Date</label>
                          <input id='nepaliDateDayBook' name="selected_date" type="text" class="form-control nepali-calendar" placeholder="YYYY-MM-DD" value="<?php echo $todayNepaliDate; ?>" >
                        </div>

                        <div class="form-group">
                          <label for="amount">Amount</label>
                          <input id='amount' type="number" class="form-control"  name="fee_amount" min="0" required placeholder="Example :2000"  >
                        </div>
...
<script>
  ...
  function OnSelectionChange (select){
    ...
    $.ajax({
      method: "get",
      url: '../student/get_fee_content.php?get_class_fee='+classId+'&fee_type='+selectedOption,
      contentType: false,
      cache: false,
      processData:false,
    })
  ...
  function OnSelectionChangeClass (select){
    $('#feeCategory').val('');
