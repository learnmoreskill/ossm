<header>
    ...
    <ul id="nav-mobile" class="side-nav fixed sideMenuBack">
        ...
        <li class="no-padding">
            <ul class="collapsible collapsible-accordion sideMenuBack">
                <li><a class="<?php if($_SESSION['navactive']=='academicsetting' || $_SESSION['navactive']=='examsetting' ){ echo "active "; } ?> collapsible-header  waves-effect waves-red lighten-2 sideMenuColor">
